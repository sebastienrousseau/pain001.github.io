...
banner_alt: "ওপেন-সোর্স Python স্যুট যা CSV, Excel, SQLite, JSON, Parquet বা SWIFT MT101 থেকে XSD-যাচাইকৃত pain.001 ও pain.008 ফাইল তৈরি করে, সঙ্গে রয়েছে AI এজেন্টের জন্য MCP টুল ও LSP সার্ভার।"
banner_height: 500
banner_width: 1200
...
excerpt: "ওপেন-সোর্স Python স্যুট যা CSV, Excel, SQLite, JSON, Parquet বা SWIFT MT101 থেকে XSD-যাচাইকৃত pain.001 ও pain.008 ফাইল তৈরি করে, সঙ্গে রয়েছে AI এজেন্টের জন্য MCP টুল ও LSP সার্ভার।"
...
## সংগঠিত ঠিকানার সময়সীমা স্থগিত

২২ নভেম্বর ২০২৫-এ MT–MX সহাবস্থান শেষ হওয়ার পর পরবর্তী মাইলফলক নির্ধারিত ছিল ১৪ নভেম্বর ২০২৬: CBPR+ সম্পূর্ণ অসংগঠিত ডাক ঠিকানা প্রত্যাখ্যান করত এবং আন্তঃব্যাংক MT101 রিলের জায়গা নিত `pain.001` সংস্করণ ৯। আগস্ট ২০২৬-এ Swift দুটি পরিবর্তনই স্থগিত করেছে এবং ডিসেম্বর ২০২৬-এর মধ্যে নতুন তারিখ ঘোষণা করবে; তবে প্রয়োজনীয়তাগুলি অপরিবর্তিত থাকছে। Pain001 ইতিমধ্যেই সংগঠিত ও হাইব্রিড ঠিকানা সামলায় এবং এক কমান্ডেই আপনার MT101 রূপান্তর করে।
