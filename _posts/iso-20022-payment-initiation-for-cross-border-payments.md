...
description: "What CBPR+ requires of your pain.001: BICFI agents, structured or hybrid addresses (deadline deferred, new date due by December 2026), charge bearers, purpose codes, with a worked xborder-ct example."
...
item_description: "What CBPR+ requires of your pain.001: BICFI agents, structured or hybrid addresses (deadline deferred, new date due by December 2026), charge bearers, purpose codes, with a worked xborder-ct example."
...
twitter_description: "What CBPR+ requires of your pain.001: BICFI agents, structured or hybrid addresses (deadline deferred, new date due by December 2026), charge bearers, purpose codes, with a worked xborder-ct example."
...
- **Structured or hybrid addresses.** Swift will reject fully free-text addresses in CBPR+; the November 2026 date was deferred and the new one is due by December 2026. Minimum viable: structured town and country, with up to two 70-character address lines (hybrid). Pain001 emits both forms.
...
Since 9 October 2025, EU PSPs must verify payee name/IBAN matches for all SEPA credit transfers before execution. VoP happens in the bank channel, not in the file. Clean, validated creditor data in your `pain.001` is still what makes the match succeed instead of stall.
