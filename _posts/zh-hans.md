...
banner_alt: "开源 Python 套件,可从 CSV、Excel、SQLite、JSON、Parquet 或 SWIFT MT101 生成经 XSD 校验的 pain.001 和 pain.008 文件，并附带面向 AI 代理的 MCP 工具和 LSP 服务器。"
banner_height: 500
banner_width: 1200
...
description: "开源 Python 套件,可从 CSV、Excel、SQLite、JSON、Parquet 或 SWIFT MT101 生成经 XSD 校验的 pain.001 和 pain.008 文件，并附带面向 AI 代理的 MCP 工具和 LSP 服务器。"
...
item_description: "开源 Python 套件,可从 CSV、Excel、SQLite、JSON、Parquet 或 SWIFT MT101 生成经 XSD 校验的 pain.001 和 pain.008 文件，并附带面向 AI 代理的 MCP 工具和 LSP 服务器。"
...
twitter_description: "开源 Python 套件,可从 CSV、Excel、SQLite、JSON、Parquet 或 SWIFT MT101 生成经 XSD 校验的 pain.001 和 pain.008 文件，并附带面向 AI 代理的 MCP 工具和 LSP 服务器。"
...
excerpt: "开源 Python 套件,可从 CSV、Excel、SQLite、JSON、Parquet 或 SWIFT MT101 生成经 XSD 校验的 pain.001 和 pain.008 文件，并附带面向 AI 代理的 MCP 工具和 LSP 服务器。"
...
MT–MX 共存期于 2025 年 11 月 22 日结束后，下一个里程碑原定于 2026 年 11 月 14 日：CBPR+ 将拒收完全非结构化的邮政地址，银行间 MT101 中继将由 `pain.001` 第 9 版取代。2026 年 8 月，Swift 推迟了这两项变更，并将在 2026 年 12 月之前公布新日期；要求本身保持不变。Pain001 已能处理结构化和混合地址，并可用一条命令转换您的 MT101。
