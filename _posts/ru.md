...
Полная документация на английском: [руководство по установке](/installation/), [технический справочник](/documentation/), [демо в браузере](/try/) и [обзор ISO 20022 на 2026 год](/2026-iso20022-migration-trends/). Ядро имеет двойную лицензию Apache-2.0 / MIT — свободное коммерческое использование в любом масштабе.
