...
## Срок для структурированных адресов перенесён

После завершения сосуществования MT–MX 22 ноября 2025 года следующий этап был намечен на 14 ноября 2026 года: CBPR+ должна была начать отклонять полностью неструктурированные почтовые адреса, а межбанковскую трансляцию MT101 должен был заменить `pain.001` версии 9. В августе 2026 года Swift отложил оба изменения и объявит новые даты не позднее декабря 2026 года; сами требования остаются в силе. Pain001 уже поддерживает структурированные и гибридные адреса и конвертирует ваш MT101 одной командой.
