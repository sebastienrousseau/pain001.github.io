...
**`pain001-loader-xlsx` v0.0.71** teaches the Pain001 core to read payment batches straight from Excel `.xlsx` and `.xlsm` workbooks. No "Save As CSV" step, no encoding surprises, no silently corrupted account numbers.
