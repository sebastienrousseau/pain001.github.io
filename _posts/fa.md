...
banner_alt: "مجموعهٔ متن‌باز Python برای تولید فایل‌های pain.001 و pain.008 اعتبارسنجی‌شده با XSD از CSV، Excel، SQLite، JSON، Parquet یا SWIFT MT101، همراه با ابزارهای MCP برای عامل‌های هوش مصنوعی و سرور LSP."
banner_height: 500
banner_width: 1200
...
excerpt: "مجموعهٔ متن‌باز Python برای تولید فایل‌های pain.001 و pain.008 اعتبارسنجی‌شده با XSD از CSV، Excel، SQLite، JSON، Parquet یا SWIFT MT101، همراه با ابزارهای MCP برای عامل‌های هوش مصنوعی و سرور LSP."
...
## مهلت نشانی ساخت‌یافته که به تعویق افتاد

پس از پایان هم‌زیستی MT–MX در ۲۲ نوامبر ۲۰۲۵، گام بعدی برای ۱۴ نوامبر ۲۰۲۶ برنامه‌ریزی شده بود: CBPR+ نشانی‌های پستی کاملاً بدون ساختار را رد می‌کرد و رلهٔ بین‌بانکی MT101 با `pain.001` نسخهٔ ۹ جایگزین می‌شد. در اوت ۲۰۲۶، Swift هر دو تغییر را به تعویق انداخت و تاریخ‌های جدید را تا دسامبر ۲۰۲۶ اعلام خواهد کرد؛ خودِ الزامات به قوت خود باقی‌اند. Pain001 از هم‌اکنون نشانی‌های ساخت‌یافته و ترکیبی را پشتیبانی می‌کند و MT101 شما را با یک فرمان تبدیل می‌کند.
