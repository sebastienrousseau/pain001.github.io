...
This reference documents the command-line interface, Python API, REST microservice, and validation pipeline for **pain001 v0.0.70**. Every flag, endpoint, and behaviour listed here is taken from the shipped code, not from aspiration.
