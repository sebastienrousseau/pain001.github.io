...
Το **Pain001** είναι σουίτα Python ανοικτού κώδικα για έναρξη πληρωμών ISO 20022. Μετατρέπει τα δεδομένα που ήδη έχετε (CSV, Excel, SQLite, JSON, Parquet ή παλαιά μηνύματα SWIFT MT101) σε XML [`pain.001`](/el/pain-001/) (μεταφορές πίστωσης) και `pain.008` (άμεσες χρεώσεις), επικυρωμένο με τα επίσημα σχήματα XSD.
