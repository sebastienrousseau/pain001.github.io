...
keywords: "pain001, ISO 20022, pain.001, SEPA, SWIFT, Python, Ελληνικά"
language: "el"
layout: "page"
locale: "el_GR"
...
name: Pain001
permalink: "https://pain001.com/el/"
rating: general
...
## Αρχεία πληρωμών που η τράπεζά σας δεν θα απορρίψει
...
Η πλήρης τεκμηρίωση είναι στα αγγλικά: [οδηγός εγκατάστασης](/installation/), [τεχνική αναφορά](/documentation/), [demo στον browser](/try/) και [ενημέρωση ISO 20022 για το 2026](/2026-iso20022-migration-trends/). Ο πυρήνας έχει διπλή άδεια Apache-2.0 / MIT — ελεύθερη εμπορική χρήση σε οποιαδήποτε κλίμακα.
