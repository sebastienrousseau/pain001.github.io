...
banner_alt: "開源 Python 套件,可從 CSV、Excel、SQLite、JSON、Parquet 或 SWIFT MT101 產生經 XSD 驗證的 pain.001 與 pain.008 檔案，並附有供 AI 代理使用的 MCP 工具與 LSP 伺服器。"
banner_height: 500
banner_width: 1200
...
excerpt: "開源 Python 套件,可從 CSV、Excel、SQLite、JSON、Parquet 或 SWIFT MT101 產生經 XSD 驗證的 pain.001 與 pain.008 檔案，並附有供 AI 代理使用的 MCP 工具與 LSP 伺服器。"
...
MT–MX 並存期於 2025 年 11 月 22 日結束後，下一個里程碑原定於 2026 年 11 月 14 日：CBPR+ 將拒收完全非結構化的郵政地址，銀行間 MT101 中繼將由 `pain.001` 第 9 版取代。2026 年 8 月，Swift 延後了這兩項變更，並將於 2026 年 12 月之前公布新日期；要求本身維持不變。Pain001 已能處理結構化與混合地址，並可用一道指令轉換您的 MT101。
