...
**`pain001-lsp` v0.0.71** is a Language Server Protocol implementation for payment-data authoring. It validates payment JSON against ISO 20022 message schemas as you type in VS Code, Neovim, Helix, Emacs, or any LSP-compliant editor.
