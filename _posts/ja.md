...
完全なドキュメントは英語です:[インストールガイド](/installation/)、[技術リファレンス](/documentation/)、[ブラウザデモ](/try/)、[2026 年 ISO 20022 ブリーフィング](/2026-iso20022-migration-trends/)。コアは Apache-2.0 / MIT のデュアルライセンスで、どの規模でも商用利用は無償です。
