...
description: "pain.001, pacs.008, camt.053, CBPR+, VoP, UETR, hybrid addresses, and control sums: the payments vocabulary defined for treasurers and operations teams, not just developers."
...
item_description: "pain.001, pacs.008, camt.053, CBPR+, VoP, UETR, hybrid addresses, and control sums: the payments vocabulary defined for treasurers and operations teams, not just developers."
...
twitter_description: "pain.001, pacs.008, camt.053, CBPR+, VoP, UETR, hybrid addresses, and control sums: the payments vocabulary defined for treasurers and operations teams, not just developers."
...
**MT101.** The legacy SWIFT "Request for Transfer" text message that `pain.001` replaces. Swift planned to retire the interbank MT101 relay in November 2026 in favour of `pain.001.001.09`, then deferred that change in August 2026 ([Swift](https://www.swift.com/news-events/news/swift-accepts-community-request-extend-structured-address-migration-iso-20022-payment-messages)); corporate-to-bank MT101 persists only at each bank's discretion.
...
**BIC / BICFI.** The ISO 9362 Business Identifier Code of a financial institution. The XML element is `<BIC>` in `pain.001.001.03` but `<BICFI>` from version 9. That rename causes real-world rejections during version upgrades.
...
**Structured / hybrid address.** Postal addresses as discrete XML elements (street, town, postcode, country) versus free-text lines. CBPR+ will reject fully unstructured addresses (Swift deferred the November 2026 date and will set a new one by December 2026); *hybrid* (structured town and country plus up to two 70-character address lines) remains valid.
...
**Remittance information.** The "what this payment is for" field, either free text (140 characters) or structured references. The thing reconciliation teams wish everyone filled in properly.
