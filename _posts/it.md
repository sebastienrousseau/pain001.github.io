...
Validate un lotto di esempio direttamente nel browser, senza caricare nulla, e provate il risultato con lo schema XSD ufficiale: [provare Pain001](/try/). File CSV di esempio sono scaricabili come modelli per le vostre esportazioni.

## La scadenza degli indirizzi strutturati, rinviata

Dopo la fine della coesistenza MT–MX il 22 novembre 2025, la tappa successiva era prevista per il 14 novembre 2026: CBPR+ avrebbe respinto gli indirizzi postali interamente non strutturati e il relay interbancario MT101 sarebbe stato sostituito da `pain.001` versione 9. Ad agosto 2026 Swift ha rinviato entrambe le modifiche e annuncerà le nuove date entro dicembre 2026; i requisiti in sé restano validi. Pain001 gestisce già indirizzi strutturati e ibridi e converte i vostri MT101 con un solo comando.
