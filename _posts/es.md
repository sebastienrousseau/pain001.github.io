...
**Pain001** es una suite Python de código abierto para la iniciación de pagos ISO 20022. Convierte los datos que ya tiene (CSV, Excel, SQLite, JSON, Parquet o mensajes SWIFT MT101 heredados) en XML [`pain.001`](/es/pain-001/) (transferencias) y `pain.008` (adeudos domiciliados) validados contra los esquemas XSD oficiales.
...
Valide un lote de ejemplo directamente en su navegador, sin subir nada, y pruebe el resultado contra el esquema XSD oficial: [probar Pain001](/try/). Hay ficheros CSV de ejemplo descargables como plantillas para sus propias exportaciones.

## La fecha límite de las direcciones estructuradas, aplazada

Desde el fin de la coexistencia MT–MX el 22 de noviembre de 2025, el siguiente hito estaba previsto para el 14 de noviembre de 2026: CBPR+ rechazaría las direcciones postales totalmente no estructuradas y el relé interbancario MT101 sería sustituido por `pain.001` versión 9. En agosto de 2026 Swift aplazó ambos cambios y anunciará nuevas fechas a más tardar en diciembre de 2026; los requisitos en sí se mantienen. Pain001 ya gestiona direcciones estructuradas e híbridas y convierte su MT101 con un solo comando.
...
Para profundizar: [guía de instalación](/installation/), [referencia técnica](/documentation/), [hoja de ruta ISO 20022 hasta 2028](/iso20022-roadmap/), [códigos de rechazo pain.002](/pain002-reason-codes/), [centro de confianza](/trust/), además del [resumen ejecutivo de una página](/es/executive-brief/), en español. La documentación completa está en inglés. El núcleo tiene doble licencia Apache-2.0 / MIT: uso comercial libre a cualquier escala.
