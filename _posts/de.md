...
Validieren Sie einen Beispielstapel direkt im Browser, ohne dass etwas hochgeladen wird, und prüfen Sie das Ergebnis gegen das offizielle XSD-Schema: [Pain001 ausprobieren](/try/). Beispiel-CSV-Dateien stehen als Vorlagen für eigene Exporte zum Download bereit.

## Die Frist für strukturierte Adressen, verschoben

Seit dem Ende der MT–MX-Koexistenz am 22. November 2025 war der nächste Meilenstein für den 14. November 2026 vorgesehen: CBPR+ sollte vollständig unstrukturierte Postadressen ablehnen, und das Interbanken-MT101-Relay sollte durch `pain.001` Version 9 ersetzt werden. Im August 2026 hat Swift beide Änderungen verschoben und wird die neuen Termine bis Dezember 2026 bekanntgeben; die Anforderungen selbst bleiben bestehen. Pain001 unterstützt strukturierte und hybride Adressen bereits heute und konvertiert Ihre MT101 mit einem Befehl.
...
Weiterführend: [Installationsanleitung](/installation/), [Technische Referenz](/documentation/), [ISO-20022-Fahrplan bis 2028](/iso20022-roadmap/), [pain.002-Ablehnungscodes](/pain002-reason-codes/), [Trust Centre](/trust/) sowie das einseitige [Kurzdossier für Entscheider](/de/executive-brief/) auf Deutsch. Die ausführliche Dokumentation ist englisch. Der Kern ist dual lizenziert (Apache-2.0 / MIT) und erlaubt freie kommerzielle Nutzung in jedem Umfang.
