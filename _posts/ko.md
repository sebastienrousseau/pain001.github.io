...
전체 문서는 영어로 제공됩니다: [설치 가이드](/installation/), [기술 레퍼런스](/documentation/), [브라우저 데모](/try/), [2026 ISO 20022 브리핑](/2026-iso20022-migration-trends/). 코어는 Apache-2.0 / MIT 이중 라이선스로, 규모와 관계없이 상업적 사용이 무료입니다.
