...
banner_alt: "CSV, Excel, SQLite, JSON, Parquet 또는 SWIFT MT101에서 XSD 검증을 마친 pain.001 및 pain.008 파일을 생성하는 오픈소스 Python 스위트로, AI 에이전트용 MCP 도구와 LSP 서버를 포함합니다."
banner_height: 500
banner_width: 1200
...
excerpt: "CSV, Excel, SQLite, JSON, Parquet 또는 SWIFT MT101에서 XSD 검증을 마친 pain.001 및 pain.008 파일을 생성하는 오픈소스 Python 스위트로, AI 에이전트용 MCP 도구와 LSP 서버를 포함합니다."
...
샘플 배치를 브라우저에서 바로 검증하고 결과를 공식 XSD 스키마로 증명하세요(아무것도 업로드되지 않습니다): [Pain001 사용해 보기](/try/). 샘플 CSV 파일은 자체 내보내기용 템플릿으로 다운로드할 수 있습니다.

## 구조화 주소 기한, 연기됨

2025년 11월 22일 MT–MX 공존 기간이 끝난 뒤 다음 이정표는 2026년 11월 14일로 예정되어 있었습니다. CBPR+는 완전히 비구조화된 우편 주소를 거부하고, 은행 간 MT101 릴레이는 `pain.001` 버전 9로 대체될 예정이었습니다. 2026년 8월 Swift는 두 변경을 모두 연기했으며 2026년 12월까지 새 날짜를 발표할 예정입니다. 요건 자체는 그대로입니다. Pain001은 이미 구조화 및 하이브리드 주소를 처리하며, MT101을 명령 하나로 변환합니다.
...
더 보기: [설치 가이드](/installation/), [기술 레퍼런스](/documentation/), [2028년까지의 ISO 20022 로드맵](/iso20022-roadmap/), [pain.002 거절 코드](/pain002-reason-codes/), [트러스트 센터](/trust/), [경영진 요약](/executive-brief/). 전체 문서는 영어입니다. Apache-2.0 / MIT 이중 라이선스이며, 규모와 관계없이 상업적 사용 무료.
