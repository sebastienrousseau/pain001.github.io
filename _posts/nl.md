...
**Pain001** is een open-source Python-suite voor ISO 20022-betalingsinitiatie. Ze zet de gegevens die u al heeft (CSV, Excel, SQLite, JSON, Parquet of oude SWIFT MT101-berichten) om in [`pain.001`](/nl/pain-001/)- (overboekingen) en `pain.008`-XML (incasso's), gevalideerd tegen de officiële XSD-schema's.
...
Valideer een voorbeeldbatch rechtstreeks in uw browser, zonder iets te uploaden, en bewijs het resultaat tegen het officiële XSD-schema: [Pain001 proberen](/try/). Voorbeeld-CSV-bestanden zijn te downloaden als sjablonen voor uw eigen exports.

## De deadline voor gestructureerde adressen, uitgesteld

Sinds het einde van de MT–MX-coëxistentie op 22 november 2025 stond de volgende mijlpaal gepland voor 14 november 2026: CBPR+ zou volledig ongestructureerde postadressen weigeren en de interbancaire MT101-relay zou worden vervangen door `pain.001` versie 9. In augustus 2026 heeft Swift beide wijzigingen uitgesteld en maakt het uiterlijk in december 2026 nieuwe data bekend; de eisen zelf blijven staan. Pain001 ondersteunt gestructureerde en hybride adressen al en converteert uw MT101 met één commando.
