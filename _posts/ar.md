...
التوثيق الكامل بالإنجليزية: [دليل التثبيت](/installation/)، [المرجع التقني](/documentation/)، [العرض التجريبي في المتصفح](/try/) و[إحاطة ISO 20022 لعام 2026](/2026-iso20022-migration-trends/). النواة مرخصة ترخيصاً مزدوجاً Apache-2.0 / MIT — استخدام تجاري حر بأي نطاق.
