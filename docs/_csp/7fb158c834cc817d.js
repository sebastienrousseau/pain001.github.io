      ...
      (function () {
        ...
        document.getElementById("break-btn").addEventListener("click", function () {
          /* Flip one digit in the first IBAN so the mod-97 check fails. */
          input.value = input.value.replace("DE89370400440532013000", "DE88370400440532013000");
          status.textContent = "One IBAN digit changed — run validation to see it caught.";
